"""
Django settings for zhiqing_server project.
...
MIDDLEWARE = [
    ...
    'zhiqing_server.middleware.JWTAuthMiddleware',  # JWT认证中间件
]
...
WSGI_APPLICATION = 'zhiqing_server.wsgi.application'
...
DATABASES = {
    ...
    'default': {
        ...
        'NAME': os.getenv('MYSQL_DB', 'zhiqing_db'),
...
LOGGING = {
    ...
    'filters': {
        'add_color_filter': {
            '()': 'zhiqing_server.utils.log_filters.ColorLogFilter',
        },
    },
    'handlers': {
        # 控制台彩色输出
        ...
        'file': {
            'level': 'INFO',
            'class': 'zhiqing_server.utils.log_handlers.DailyRotatingFileHandler',
